	    ...
	    <div class="row">
			<div class="col-md-9">
                ...
                <td> {{$v->tender_class}}</td>
								...
								<td> <a href="{{ route('tender.user.edit', $v->id) }}"> Edit </td>
								<td> <a href="{{ route('user.tender.delete', $v->id) }}" onclick="return confirm('Are you sure you want to delete this item ? This action can not be undone');"> Delete </td>
